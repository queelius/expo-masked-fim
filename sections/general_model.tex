...
\begin{figure}
	...
	\end{center}
\end{figure}
If a sample of masked system failures has variable sized candidate sets, we are free to use any parameter-free estimator of the probability mass function of $\RV{W}$, e.g., the empirical distribution as described in \cref{appendix:generalized_general_joint_likelihood_cand}.
