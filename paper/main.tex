...
\item For $w = m-1$---the maximally uninformative masking configuration that remains identifiable---the score equations linearize and a closed-form MLE exists for arbitrary~$m$. This provides worst-case analytical performance bounds for the hardest identifiable masking scenario
